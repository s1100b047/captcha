...
public partial class questionimage : System.Web.UI.Page
{
    private string RndNum() //隨機生成驗證碼
    {
        Random rnd = new Random(Guid.NewGuid().GetHashCode());
        int number = rnd.Next(0, 6);
        string[] arr_question = {"How many shape are there?",
                             "How many circycle are there?",
                             "How many triangle are there?",
                             "How many square are there?",
                             "What is the image background color?",
                             "What is the most shape in this image?"};
        string question = arr_question[number];
        Session["question"] = question;
        return question;
    }
    private void CreatequestionImage(string question)//將驗證碼生成圖片
    {
        if (question == null || question.Trim() == String.Empty)
            return;
        System.Drawing.Bitmap image = new System.Drawing.Bitmap((int)Math.Ceiling(question.Length * 17.0), 35);
        ...
        try
        {
            ...
            Font font = new System.Drawing.Font("Verdana", 15, (System.Drawing.FontStyle.Bold | System.Drawing.FontStyle.Italic));
            ...
            g.DrawString(question, font, brush, 2, 2);
    ...
    {
        this.CreatequestionImage(RndNum());
