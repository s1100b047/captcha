...
public partial class answerimage : System.Web.UI.Page
{
    private string Answer1()
    {
        string digital = String.Empty; ;digital = Session["circyle"].ToString();
    ...
    private void shapeImage(string color)//將隨機圖形生成圖片
    {
        ...
        string shapenumber = String.Empty;
        shapenumber = "11";
        g.FillEllipse(sb, 25, 25, 50, 50);
        Session["shapenumber"] = shapenumber.ToString();
