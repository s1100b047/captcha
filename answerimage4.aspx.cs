...
public partial class answerimage4 : System.Web.UI.Page
{
    private string Answer1()
    {
        string digital4 = String.Empty; ;
        digital4 = "0";
        Session["digital4"] = digital4;
        return digital4;
    }
    private string Answer2()
    {
        string count4 = String.Empty; ;
        count4 = "3";
        Session["count4"] = count4.ToString();
        return count4;
    }
    private void shapeImage(string color)//將隨機圖形生成圖片
    {
        ...
        string shapenumber4 = String.Empty;
        g.FillEllipse(sb, 10, 10, 20, 20);
        shapenumber4 = "14";
        g.DrawLine(pen, 30, 30, 30, 70);
        g.DrawLine(pen, 30, 70, 60, 70);
        g.DrawLine(pen, 60, 70, 30, 30);
        g.DrawRectangle(pen, 67, 67, 30, 30);
        Brush blueBrush = new SolidBrush(Color.Blue);
        Session["shapenumber4"] = shapenumber4.ToString();
    ...
    private void colorImage(string color)//將亂數數字生成圖片
    {
        ...
        string colornumber4 = String.Empty;
        Session["colornumber4"] = "24";
